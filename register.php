...
<form action="registerUser.php" method="post" class="form-signin">
  <h1 class="h3 mb-3 font-weight-normal" style="padding-top: 80px;">Please Register</h1>
  ...
  <button name="submit" class="btn-primary" type="submit">Sign in</button>
